...
import './Gallery.scss'
import CombinedImage  from '../../images/gallery/CombinedImage.png';
        ...
        <Container fluid className="main-featured-cont px-0">
            <div className="featured-wrapper">
                ...
                <div className="main-body">
                    <div className="pro-1">
                        <Image src={CombinedImage} className="picture" />
                    </div>
                </div>
            </div>
            <div ref={itemsRef}  className="all-projects" data-depth="0.7">Arushi Gandhi - Sister Of The Nation</div>

            <div className="done-text-section">
